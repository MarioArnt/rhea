...
describe('message content', function () {
    ...
    it(
        ...
        transfer_test(
            ...
            function (message: rhea.Message) {
                assert.equal(
                    message.application_properties!.bigneg,
                    -1234567898765
                )
            }
        )
    ...
    it(
        ...
        transfer_test(
            ...
            function (message: rhea.Message) {
                assert.equal(
                    message.body,
                    new Array(1024 * 1024 * 50 + 1).join('z')
                )
            }
        )
    )
    ...
    it(
        ...
        transfer_test(
            {
                body: new Map<any, any>([
                    [amqp_types.wrap_uuid(Buffer.alloc(16)), 1],
                ]),
            },
            function (message: rhea.Message) {
    ...
    beforeEach(function (done: Function) {
        ...
        server.on('released', function (context: rhea.EventContext) {
            ...
            outcome.delivery_failed =
                context.delivery!.remote_state!.delivery_failed
