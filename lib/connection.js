...
var Connection = function (options, container) {
    ...
    if (options) {
        ...
        if (
            (options.transport === 'tls' || options.transport === 'ssl') &&
...
Connection.prototype.init = function (socket) {
    ...
    if (this.is_server) {
        ...
        if (
            this.container &&
            Object.getOwnPropertyNames(this.container.sasl_server_mechanisms)
                .length
        ) {
...
Connection.prototype.get_tls_socket = function () {
    if (
        this.socket &&
        (this.options.transport === 'tls' || this.options.transport === 'ssl')
    ) {
        return this.socket
    } else {
        return undefined
