...
container.on('receiver_open', function (context) {
    context.receiver.set_target({
        address: context.receiver.remote.attach.target.address,
    })
})
...
container.on('message', function (context) {
    ...
    response.body = upper
    var o = context.connection.find_sender(function (s) {
        return match_source_address(s, reply_to)
    })
    if (o) {
        o.send(response)
    }
