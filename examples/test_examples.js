...
describe('brokered examples', function () {
    ...
    it('client/server', function (done) {
        ...
        while_running(done, [
            example('server.js').produces(server_output),
        ]).verify([example('client.js').produces(client_output)])
    })
    ...
    it('pub-sub', function (done) {
        ...
        var pub = example(
            'durable_subscription/publisher.js',
            messages
        ).produces(pub_output)
    ...
    it('queue browser', function (done) {
        ...
        function consume(f) {
            verify(f, [
                example('simple_recv.js', ['-m', '4']).produces(recv_output),
            ])
        }
        function send(f) {
...
describe('direct examples', function () {
    ...
    it('helloworld', function (done) {
        verify(done, [
            example('direct_helloworld.js').produces('Hello World!\n'),
        ])
    })
    it('send and receive', function (done) {
        verify(done, [
    ...
    it('client/server', function (done) {
        ...
        while_running(done, [
            ...
            example('client.js', ['-p', '8888']).produces(client_output),
        ])
    })
